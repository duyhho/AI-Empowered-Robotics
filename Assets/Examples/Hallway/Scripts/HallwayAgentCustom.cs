...
public class HallwayAgentCustom : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        if (m_Selection == 0)
        {
            symbolO.transform.position =
                new Vector3(0f, 2f, blockOffset + Random.Range(-3f, 3f))
        ...
        if (goalPos == 0)
        {
            ...
            //3x
            // symbolOGoal.transform.position = new Vector3(Random.Range(7f, 25f), 0.5f, 22.29f) + area.transform.position;
            // symbolXGoal.transform.position = new Vector3(Random.Range(-7f, -25f), 0.5f, 22.29f) + area.transform.position;
        }
        else
        {
            symbolXGoal.transform.position = new Vector3(7f, 0.5f, 22.29f) + area.transform.position;
