...
public class CrawlerAgent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        /* 
        With inverse: You get the body's current forward direction in the coordinate space defined by the target direction. 
        This essentially gives you the orientation error or deviation of the body's forward direction from the target direction.

Without inverse: You get where the body would be pointing if it was perfectly aligned with the target. 
This doesn't tell you anything about the body's current orientation relative to the target, but rather gives an idealized direction.
        */
